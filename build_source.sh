...
./ffmpeg -report -re -fflags +genpts -fflags nobuffer -probesize 50 -analyzeduration 100 -stream_loop -1 -i ./2-cat.mp4 -c:v copy -acodec copy -f flv rtmp://10.9.119.38/live/ch2 > /dev/null 2>&1 &
